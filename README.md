...
AxelChat is an application that combines chats from various streaming and other platforms and displays them in one window or widget. It supports a large number of platforms, has a user-friendly interface and many useful functions
